...
import type { ProjectHealthStatus } from '../../services/project-health.service';
import { Activity, AlertTriangle, CheckCircle, XCircle } from 'lucide-react';

export const ProjectHealthBadge = ({ status }: { status: ProjectHealthStatus }) => {
  const getStyles = (s: ProjectHealthStatus) => {
    switch (s) {
